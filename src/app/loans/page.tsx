    ...
    <div className="max-w-4xl mx-auto space-y-6 py-4">
      ...
      {(!data || data.length === 0) ? (
        ...
        <div className="grid gap-4">
          {data.map((loan: { id: string; name: string; lender: string | null; principal: number; balance: number; interestRate: number; monthlyPayment: number; termMonths: number; status: string; progress: number; remainingMonths: number; monthsPaid: number }) => (
            <div key={loan.id} className="bg-surface rounded-[12px] shadow-elevation-1 p-5 hover:shadow-elevation-2 transition-shadow">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3 text-body-small">
